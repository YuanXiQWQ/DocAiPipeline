                                            ...
                                            <div className="overflow-x-auto mt-2">
                                                <table className="min-w-full text-xs border-collapse">
                                                    ...
                                                    <tr className="bg-slate-100">
                                                        {cols.map((c) => (
                                                            <th key={c}
                                                                className="px-2 py-1 border border-slate-200 text-left font-medium text-slate-600 whitespace-nowrap">
                                                                {c}
                                                            </th>
                                                        ))}
                                                    </tr>
                                                    ...
                                                    {entries.slice(0, 50).map((row, rIdx) => (
                                                        <tr key={rIdx}
                                                            ...
                                                            {cols.map((c) => (
                                                                <td key={c}
                                                                    className="px-2 py-1 border border-slate-200 text-slate-700 whitespace-nowrap">
                                                                    {String(row[c] ?? "")}
                                                                </td>
                                                            ))}
                                                        </tr>
